...
import { easyAI, mediumAI, hardAI } from "../config/env.js";
import { EngineServiceEndpoint } from "../../../c-common/src/config/env.js";
...
export const makeAIMove = async (gameId) => {
  ...
  try {
    const aiConfig = gameObj.AIConfig;
    const res = await axios.post(
      `${EngineServiceEndpoint}/api/engine/getBestMove`,
      {
        fen,
        aiConfig,
      },
